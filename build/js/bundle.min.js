function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(e){const n=document.querySelector(".navegacion");n.classList.contains("mostrar")?n.classList.remove("mostrar"):n.classList.add("mostrar")}
