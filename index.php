...
<main class="contenedor seccion">
  ...
  <div class="iconos-nosotros">
    <div class="icono">
      ...
      <h3>Seguridad</h3>
      <p>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid voluptatibus, incidunt architecto id laborum
        eaque laboriosam totam reprehenderit sit tempore!
      </p>
    </div>
    <div class="icono">
    ...
    <article class="entrada-blog">
      ...
      <div class="texto-entrada">
        <a href="entrada.php">
          ...
          <p class="informacion-meta">Escrito el: <span>15/04/2023</span> por: <span>Admin</span></p>
          <p>Maximiza el espaciado en tu hogar con esta guía, aprende a combinar muebles y colores para darle vida a tu
            espacio.</p>
        </a>
      </div>
    </article>
